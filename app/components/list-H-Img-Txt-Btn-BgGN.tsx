...
import BtnLgBgGViolet from './btn-Lg-BgGViolet';
...
interface ListHImgTxtBtnBgGProps {
  cards: CarteData[];
}

const ListHImgTxtBtnBdG: React.FC<ListHImgTxtBtnBgGProps> = ({ cards }) => {
              ...
              <div className="flex flex-col md:flex-row items-start p-3">
                ...
                <div className="w-full md:w-2/3 flex flex-col text-left pl-4 mt-4">
                  ...
                  <div className="w-full pt-3 pb-3">
                    <BtnLgBgGViolet interneUrl={card.btnUrlInt || ""} externalUrl={card.btnUrlExt || ""}>
                      {card.btnTexte}
                    </BtnLgBgGViolet>
                  </div>
                </div>
...
export default ListHImgTxtBtnBdG;
